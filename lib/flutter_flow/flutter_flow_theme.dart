...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF630F12);
  late Color secondary = const Color(0xFFFFF3DE);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF630F12);
  late Color secondaryText = const Color(0xFFFFF3DE);
