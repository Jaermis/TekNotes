...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/notesStorage',
          requireAuth: true,
          builder: (context, params) => const NotesStorageWidget(),
        ),
        FFRoute(
          name: 'ProfilePage',
          path: '/profilePage',
        ...
        FFRoute(
          name: 'ForumPage',
          path: '/forumPage',
          builder: (context, params) => const ForumPageWidget(),
        ),
        FFRoute(
          name: 'QuizzesPage',
          path: '/quizzesPage',
        ...
        FFRoute(
          name: 'PomodoroPage',
          path: '/pomodoroPage',
          builder: (context, params) => const PomodoroPageWidget(),
        ),
        FFRoute(
          name: 'SignupPage',
          path: '/signupPage',
        ...
        FFRoute(
          name: 'NotifPage',
          path: '/notifPage',
          builder: (context, params) => const NotifPageWidget(),
        )
