...
class _ProfilePageWidgetState extends State<ProfilePageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (valueOrDefault(currentUserDocument?.accType, '') == 'Student') {
        _model.rank = await queryUsersRecordOnce(
          queryBuilder: (usersRecord) => usersRecord
              .where(
                'acc_type',
                isEqualTo: 'Student',
              )
              .orderBy('contribution_points', descending: true),
        );
      } else {
        _model.rank1 = await queryUsersRecordOnce(
          queryBuilder: (usersRecord) => usersRecord
              .where(
                'acc_type',
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      ...
                      text: FFLocalizations.of(context).getText(
                        'irystcjw' /* Need Help? Give us your feedba... */,
                      ),
                      options: FFButtonOptions(
                        height: 40.0,
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) => Text(
                                      'ID Number: (${valueOrDefault(currentUserDocument?.idNum, '')})',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Montserrat',
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 25.0, 0.0, 0.0),
                                child: FlutterFlowIconButton(
                                  borderColor: const Color(0xFFFFF3DE),
                                  borderRadius: 20.0,
                                  borderWidth: 0.0,
                                  buttonSize: 40.0,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              AuthUserStreamWidget(
                                builder: (context) => Text(
                                  '${valueOrDefault(currentUserDocument?.accType, '')},',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Montserrat',
                              ...
                              Padding(
                                ...
                                child: AuthUserStreamWidget(
                                  builder: (context) => Text(
                                    valueOrDefault(
                                        currentUserDocument?.userCourse, ''),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Montserrat',
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await launchURL(valueOrDefault(
                                          currentUserDocument?.githubLink, ''));
                                    },
                                    text: FFLocalizations.of(context).getText(
                                      '33ban6ud' /* GitHub */,
                                    ),
                                ...
                                Flexible(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await launchURL(valueOrDefault(
                                          currentUserDocument?.personalLink,
                                          ''));
                                    },
                                    text: FFLocalizations.of(context).getText(
                                      'cg170o5a' /* Personal Website */,
                                    ),
                                    icon: const FaIcon(
